...
import { Stethoscope, Loader2, CheckCircle, ArrowRight } from 'lucide-react';
...
export default function ForgotPasswordPage() {
  ...
  if (done) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-teal-50 to-sky-50 px-4" dir="rtl">
        <div className="w-full max-w-md">
          <div className="bg-white rounded-2xl shadow-sm p-8 text-center">
            ...
            <Link href="/auth/login" className="inline-flex items-center gap-2 text-teal-600 font-medium text-sm hover:underline">
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-teal-50 to-sky-50 px-4" dir="rtl">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 text-sm mt-1">ميديفلو — بوابة الأطباء</p>
        </div>
        ...
        <p className="text-center text-sm text-gray-600 mt-4">
          تذكّرت كلمة المرور؟{' '}
          <Link href="/auth/login" className="text-teal-600 font-semibold hover:underline">سجّل الدخول</Link>
        </p>
      </div>
    </div>
  );
